      ...
      <div style={{ paddingTop: '30px' }} className="container mx-auto">
        {
          loading ?
            <div className="d-flex justify-content-center align-items-center my-5 fs-4">
              <img width={'500px'} height={'500px'} className='me-2' src="https://loading.io/assets/mod/spinner/spinner/lg.gif" alt="loading" />Loading...
            </div>
            :
            <>
              <div className='row align-items-start'>
                {
                  allRecipes?.length > 0 ?
                    visibleRecipeCard?.map(recipe => (
                      <div key={recipe?.id} style={{ height: '400px' }} className='col-lg-3 rounded border p-2 mb-5 shadow'>
                        ...
                        <div className='text-center  mt-4'>
                          ...
                          <div className='d-flex justify-content-center align-items-center mt-1'>
                            <Link style={{ backgroundColor: 'rgb(139, 130, 34)' }} className='btn rounded p-2 mt-1 text-light inline-block' to={`${recipe?.id}/view`}>View More</Link>
                          </div>
                        </div>
                      </div>
                    ))
